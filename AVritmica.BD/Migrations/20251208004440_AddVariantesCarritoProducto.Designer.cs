...
namespace AVritmica.BD.Migrations
{
    ...
    [Migration("20251208004440_AddVariantesCarritoProducto")]
    partial class AddVariantesCarritoProducto
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AVritmica.BD.Data.Entity.CarritoProducto", b =>
                {
                    ...
                    b.HasIndex(new[] { "CarritoId", "ProductoId", "Color", "Tamaño" }, "IX_CarritoProductos_CarritoProductoVariante")
                        .IsUnique()
                        .HasFilter("[Color] IS NOT NULL AND [Tamaño] IS NOT NULL");
            ...
            modelBuilder.Entity("AVritmica.BD.Data.Entity.Producto", b =>
                {
                    ...
                    b.Property<string>("ColoresDisponibles")
                        .IsRequired()
                        .HasMaxLength(500)
                    ...
                    b.Property<string>("ImagenesVariantes")
                        .IsRequired()
                        .HasMaxLength(2000)
                    ...
                    b.Property<string>("StockPorColor")
                        .IsRequired()
                        .HasMaxLength(2000)
                        .HasColumnType("nvarchar(2000)");

                    b.Property<string>("TamaniosDisponibles")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
            ...
            modelBuilder.Entity("AVritmica.BD.Data.Entity.StockMovimiento", b =>
                {
                    ...
                    b.HasIndex(new[] { "Proveedor" }, "IX_StockMovimientos_Proveedor");
